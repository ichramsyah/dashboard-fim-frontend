          ...
          <div>
            ...
            <div className="bg-white px-7 py-6 rounded-lg mt-7">
              ...
              <div className="px-1 w-full pb-6">
                <h2 className="text-gray-7 text-lg font-semibold md:mb-4 lg:mb-4 sm:mb-0">Laporan Hari ini</h2>
                <div className="gap-2 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 mt-2">
                  <StatCard icon={<FaShieldAlt size={22} />} title="Total Perubahan" value={todayStats?.total_perubahan_hari_ini ?? 0} color="text-gray-700/80" bgColor="bg-gray-100" />
                  <StatCard icon={<FaBell size={22} />} title="Normal" value={todayStats?.detail.normal ?? 0} color="text-blue-500/80" bgColor="bg-blue-100" />
                  <StatCard icon={<FaExclamationTriangle size={22} />} title="Mencurigakan" value={todayStats?.detail.mencurigakan ?? 0} color="text-yellow-500/80" bgColor="bg-yellow-100" />
                  <StatCard icon={<FaExclamationTriangle size={22} />} title="Bahaya" value={todayStats?.detail.bahaya ?? 0} color="text-red-500/80" bgColor="bg-red-100" />
                </div>
                <div className="mt-8 grid grid-cols-1 lg:grid-cols-1 gap-6">
                  <LogTable title="Normal" logs={todayLogs.normal} bgColor="bg-blue-100" />
                  <LogTable title="Mencurigakan" logs={todayLogs.mencurigakan} bgColor="bg-yellow-100" />
                  <LogTable title="Bahaya" logs={todayLogs.bahaya} bgColor="bg-red-100" />
                </div>
              </div>
            </div>
          </div>
